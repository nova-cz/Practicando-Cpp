...
?Los mapas tienen una key desde la cual podemos acceder a ellos,  y un valor asociado a esa key.

*La key puede ser de cualquier tipo, pero no puede ser repetida, si se repite se sobreescribe el valor.
 */
